...
class Praticiens
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Visites::class, mappedBy="vst_praticien_id")
     */
    private $pra_visites;
    ...
    public function addPraVisite(Visites $praVisite): self
    {
        if (!$this->pra_visites->contains($praVisite)) {
            ...
            $praVisite->setVstPraticienId($this);
        }
    ...
    public function removePraVisite(Visites $praVisite): self
    {
        if ($this->pra_visites->removeElement($praVisite)) {
            ...
            if ($praVisite->getVstPraticienId() === $this) {
                $praVisite->setVstPraticienId(null);
            }
        }
